...
class GizmosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gizmo" do
    assert_difference("Gizmo.count") do
      post gizmos_url, params: { gizmo: { bool1: @gizmo.bool1, string1: @gizmo.string1, title: @gizmo.title, type: @gizmo.type } }
    end
  ...
  test "should update gizmo" do
    patch gizmo_url(@gizmo), params: { gizmo: { bool1: @gizmo.bool1, string1: @gizmo.string1, title: @gizmo.title, type: @gizmo.type } }
